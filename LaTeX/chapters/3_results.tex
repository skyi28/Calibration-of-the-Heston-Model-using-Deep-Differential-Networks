...
\begin{table}[H]
    ...
    \begin{tabular}{lrrrrrrr}
        ...
        \midrule
        \makecell[l]{Pre-Volmageddon \\ \textit{\footnotesize (Jan 2015 - Jan 2018)}} & 0.045 & 0.018 & 0.937 & 0.026 & 0.278 & 0.158 & 0.027 \\
        \makecell[l]{Trade War \\ \textit{\footnotesize (Feb 2018 - Jan 2020)}} & 0.046 & 0.020 & 0.866 & 0.021 & 0.254 & 0.151 & 0.033 \\
        \makecell[l]{COVID Crash \\ \textit{\footnotesize (Feb 2020 - May 2020)}} & 0.056 & 0.018 & 0.922 & 0.028 & 0.261 & 0.256 & 0.161 \\
        \makecell[l]{Recovery \\ \textit{\footnotesize (Jun 2020 - Dec 2021)}} & 0.047 & 0.020 & 1.007 & 0.023 & 0.353 & 0.212 & 0.082 \\
        \makecell[l]{Inflation \\ \textit{\footnotesize (Jan 2022 - Dec 2023)}} & 0.038 & 0.010 & 0.817 & 0.030 & 0.201 & 0.137 & 0.037 \\
        \bottomrule
    \end{tabular}
    \begin{tablenotes}
...
The analysis of the call option performance reveals a distinct and theoretically consistent pattern. The model achieves its highest accuracy, with \ac{mre}s as low as 2.3\%, for \ac{itm} (moneyness < 0.95) and \ac{atm} (moneyness 0.95-1.05) contracts, particularly those with longer maturities. This region represents the most liquid and highest-priced segment of the call option market. Conversely, the calibration error is highest for \ac{otm} (moneyness > 1.05) calls, reaching a peak of 12.7\% for contracts with less than three months to expiration. This behavior is a known characteristic of the \ac{mre} metric; \ac{otm} options have very low absolute prices, causing even small absolute pricing errors to translate into large relative errors.
...
\begin{table}[H]
    ...
    \begin{tabular}{lrrr}
        ...
        \midrule
        Pre-Volmageddon & 4.59 & 5.04 & 0.45 \\
        Trade War & 4.47 & 5.06 & 0.59 \\
        COVID Crash & 5.60 & 5.59 & -0.01 \\
        Recovery & 4.63 & 5.01 & 0.38 \\
        Inflation & 3.75 & 4.05 & 0.30 \\
        \midrule
        \textbf{Overall Average} & \textbf{4.48} & \textbf{4.87} & \textbf{0.39} \\
        \bottomrule
    \end{tabular}
    \begin{tablenotes}
        \item[a] \ac{mre} calculated using the trained \ac{ddn} as a surrogate pricer.
        \item[b] \ac{mre} calculated using the \ac{ddn}'s calibrated parameters in QuantLib's \texttt{AnalyticHestonEngine}.
        \item[c] The increase in \ac{mre} attributable to removing the \ac{ddn}'s surrogate pricing function.
    \end{tablenotes}
    \end{threeparttable}
\end{table}