...
The time-series evolution of the daily calibration error is presented in Figure \ref{fig:robustness_analysis}. This figure plots both the in-sample \ac{mre}, calculated on the 80\% of options used for calibration, and the validation \ac{mre}, calculated on the 20\% held-out set. The 20-day realized volatility of the underlying \ac{aapl} stock is overlaid to provide market context.
